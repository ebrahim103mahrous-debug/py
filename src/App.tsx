        ...
        {item.code && (
          <div className="col-span-12 space-y-6">
            <div className="bento-card bg-slate-50 overflow-hidden shadow-inner relative border border-slate-200 rounded-2xl w-full max-w-full">
              ...
              <div className="p-4 md:p-6 lg:p-8 font-mono text-[13px] md:text-sm lg:text-base text-slate-800 bg-white overflow-auto max-h-[60vh] leading-relaxed text-left w-full" dir="ltr">
                <pre className="text-left inline-block min-w-full"><code className="whitespace-pre text-left block" dir="ltr">{item.code}</code></pre>
              </div>
            </div>
