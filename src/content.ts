  ...
  },
  {
    ...
    problems: [
      ...
      },
      {
        ...
        algorithmAr: "1. إعداد متغير 'correct' يحفظ بداخله الرقم السري الصحيح.\n2. تشغيل حلقة (while True) تدور بلا توقف.\n3. تطلب الحلقة في كل دورة من المستخدم إدخال كلمة سر.\n4. تطابق المدخل مع الرقم السري (correct).\n5. إن تطابقا، يطبع البرنامج ترحيباً ويستدعي الكلمة break لتكسر الحلقة.\n6. إن لم يتطابقا سيطبع 'Try again' ويعيد السؤال.",
        flowchartData: "Start -> correct='1234' -> Loop: Input pwd -> pwd==correct? -> Yes: Welcome, Break -> No: Try again -> End",
        lineByLineAr: [
          { line: "while True:", explanation: "حلقة لا نهائية ستستمر في التكرار حتى نوقفها يدوياً." },
          { line: "break", explanation: "أمر إيقاف فوري يخرج البرنامج من حلقة while بأكملها." }
        ]
      }
    ]
  },
